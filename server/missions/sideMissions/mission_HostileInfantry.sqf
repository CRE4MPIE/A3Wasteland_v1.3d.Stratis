...
_setupVars =
{
	...
	_locArray = ((call cityMissionList) call BIS_fnc_selectRandom);
...
_randomCase = ["Box_FIA_Support_F","Box_FIA_Wps_F","Box_FIA_Ammo_F","Box_NATO_WpsSpecial_F","Box_East_WpsSpecial_F","Box_NATO_Ammo_F","Box_East_Ammo_F"] call BIS_fnc_selectRandom;
	...
	_box1 = createVehicle [_randomCase,[(_missionPos select 0), (_missionPos select 1),5],[], 0, "NONE"];
...
_randomCase = ["Box_FIA_Support_F","Box_FIA_Wps_F","Box_FIA_Ammo_F","Box_NATO_WpsSpecial_F","Box_East_WpsSpecial_F","Box_NATO_Ammo_F","Box_East_Ammo_F"] call BIS_fnc_selectRandom;
	...
	_box2 = createVehicle [_randomCase,[(_missionPos select 0), (_missionPos select 1),5],[], 0, "NONE"];
