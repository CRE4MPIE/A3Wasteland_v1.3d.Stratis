...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%2'>%1</t> transporting weapon crates is being escorted by armed vehicles. Stop them!", _vehicleName, mainMissionColor];
...
_randomCase = ["Box_FIA_Support_F","Box_FIA_Wps_F","Box_FIA_Ammo_F","Box_NATO_WpsSpecial_F","Box_East_WpsSpecial_F","Box_NATO_Ammo_F","Box_East_Ammo_F"] call BIS_fnc_selectRandom;
	...
	_box1 = createVehicle [_randomCase,_lastPos, [], 2, "None"];
...
_randomCase = ["Box_FIA_Support_F","Box_FIA_Wps_F","Box_FIA_Ammo_F","Box_NATO_WpsSpecial_F","Box_East_WpsSpecial_F","Box_NATO_Ammo_F","Box_East_Ammo_F"] call BIS_fnc_selectRandom;
	...
	_box2 = createVehicle [_randomCase,_lastPos, [], 2, "None"];
