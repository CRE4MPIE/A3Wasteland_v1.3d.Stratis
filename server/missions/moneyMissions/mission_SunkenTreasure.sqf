...
_setupObjects =
{
	...
	_box1 = createVehicle ["_randomCase", _missionPos, [], 0, "None"];
	...
	_missionHintText = format ["A treasure trove containing <t color='%1'>$1,000,000</t> and weapons is being recovered.<br/>If you want to capture it, you will need diving gear and an underwater weapon.", moneyMissionColor];
};
