...
_setupObjects =
{
	...
	_vehicleName = "Laptop";
	_missionHintText = format ["<t color='%2'>Hackers</t> are using a laptop to hack your bank accounts. Hacking the laptop successfully will steal money from each on-line enemy players bank account! ", _vehicleName, moneyMissionColor];
};
